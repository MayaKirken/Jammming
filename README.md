...
View Live Application on Netlify
🚀 Live Features
...
Clone the repository: git clone https://github.com/MayaKirken/Jammming.git Navigate into the project directory: cd jammming Install dependencies: npm install Start the local development server: npm run dev Open your browser and navigate to the localhost port indicated in your terminal (typically http://localhost:5173).
